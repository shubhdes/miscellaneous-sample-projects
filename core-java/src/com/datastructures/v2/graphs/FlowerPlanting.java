...
public class FlowerPlanting {
    ...
    private boolean solve(List<List<Integer>> graph, int n, int[] gardens, int garden) {
    ...
    private boolean isSafe(List<List<Integer>> graph, int n, int[] gardens, int garden, int color) {
